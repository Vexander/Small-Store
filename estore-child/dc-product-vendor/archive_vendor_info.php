	...
	<div class="vendor_description">
		<div class="vendor_img_add">
			...
			<div class="vendor_address">
				<?php if(!empty($location) && $vendor_hide_address != 'Enable') { ?><p><img height="25" width="25" src=<?php echo $WCMp->plugin_url . 'shortcode/assets/images/location_pin.png';?> /><label><?php echo apply_filters( 'vendor_shop_page_location', $location, $vendor_id ); ?></label></p><?php } ?>
				<?php if(!empty($mobile) && $vendor_hide_phone != 'Enable') { ?><p><img height="25" width="25" src=<?php echo $WCMp->plugin_url . 'shortcode/assets/images/mobile-phone.png';?> /><label><?php echo apply_filters( 'vendor_shop_page_contact', $mobile, $vendor_id ); ?></label></p><?php } ?>
				<?php if(!empty($email) && $vendor_hide_email != 'Enable') { ?><p><img height="25" width="25" src=<?php echo $WCMp->plugin_url . 'shortcode/assets/images/email_envelope_message.png';?> /><label><?php echo apply_filters( 'vendor_shop_page_email', $email, $vendor_id ); ?></label></p><?php } ?>
		...
		<div class="description">
			...
			?>
				<?php if($vendor_fb_profile) { ?> <a target="_blank" href="<?php echo esc_url($vendor_fb_profile); ?>"><img src="<?php echo $WCMp->plugin_url . 'shortcode/assets/images/facebook.png';?>" alt="facebook" height="20" width="20" ></a><?php } ?>
				<?php if($vendor_twitter_profile) { ?> <a target="_blank" href="<?php echo esc_url($vendor_twitter_profile); ?>"><img src="<?php echo $WCMp->plugin_url . 'shortcode/assets/images/twitter.png';?>" alt="twitter" height="20" width="20" ></a><?php } ?>
				<?php if($vendor_linkdin_profile) { ?> <a target="_blank" href="<?php echo esc_url($vendor_linkdin_profile); ?>"><img src="<?php echo $WCMp->plugin_url . 'shortcode/assets/images/linkedin.png';?>" alt="linkedin" height="20" width="20" ></a><?php } ?>
				<?php if($vendor_google_plus_profile) { ?> <a target="_blank" href="<?php echo esc_url($vendor_google_plus_profile); ?>"><img src="<?php echo $WCMp->plugin_url . 'shortcode/assets/images/google-plus.png';?>" alt="google_plus" height="20" width="20" ></a><?php } ?>
				<?php if($vendor_youtube) { ?> <a target="_blank" href="<?php echo esc_url($vendor_youtube); ?>"><img src="<?php echo $WCMp->plugin_url . 'shortcode/assets/images/youtube.png';?>" alt="youtube" height="20" width="20" ></a><?php } ?>
				<?php if($vendor_instagram) { ?> <a target="_blank" href="<?php echo esc_url($vendor_instagram); ?>"><img src="<?php echo $WCMp->plugin_url . 'shortcode/assets/images/instagram.png';?>" alt="instagram" height="20" width="20" ></a><?php } ?>
			</div>
		</div>
	</div>
</div>	
